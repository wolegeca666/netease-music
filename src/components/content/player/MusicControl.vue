      ...
      <scale>
        <svg class="icon" height="128" p-id="28290"
          ...
          <path d="M422.1 529.7l207.6 141.9c10.4 7.1 24.5 4.4 31.6-5.9 2.6-3.8 4-8.3 4-12.8V369c0-12.6-10.2-22.8-22.8-22.8-4.6 0-9.1 1.4-12.8 4L422.1 492.1c-10.4 7.1-13 21.3-5.9 31.6 1.6 2.4 3.6 4.4 5.9 6z m-80.8-142.9v250.4c0 12.5 10.2 22.7 22.8 22.7 12.7 0 22.8-10.2 22.8-22.7V386.8c0-12.5-10.2-22.7-22.8-22.7-12.7 0-22.8 10.2-22.8 22.7zM512 1024C229.2 1024 0 794.8 0 512S229.2 0 512 0s512 229.2 512 512-229.2 512-512 512z"
                fill="#d81e06" p-id="28291"></path>
        </svg>
      </scale>
    </div>
    <div @click="cut(!play)" class="play"> <!--切换播放-->
      <scale>
        <svg class="icon-play" height="128" p-id="16320"
             t="1602216999432" v-show="play"
             version="1.1" viewBox="0 0 1024 1024" width="128"
             xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="icon-play" height="128" p-id="14196"
             t="1602216950051"
             v-show="!play" version="1.1" viewBox="0 0 1024 1024"
             width="128" xmlns="http://www.w3.org/2000/svg">
          <path class="selected"
                d="M0 512C0 229.248 229.248 0 512 0s512 229.248 512 512-229.248 512-512 512S0 794.752 0 512z m400.96-231.1552c-32.896-18.1248-59.6224-2.4832-59.6224 35.0592v392.1536c0 37.2736 26.688 53.2224 59.6224 35.0592l359.1168-198.208c32.8448-18.1632 32.9088-47.6544 0-65.8432L400.96 280.832z" data-spm-anchor-id="a313x.7781069.0.i6"
                fill="#d81e06" p-id="14197"></path>
